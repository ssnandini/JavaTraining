package com.nan.firstspringboot.entity;
...
public class Traveller {
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO) //SEQUENCE, generator = "tra_seq")
 //   @SequenceGenerator(name = "tra_seq", sequenceName = "tra_seq")	
